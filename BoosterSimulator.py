import pandas as pd
import numpy as np
#from pyatmos import coesa76 as atmo
...
#ax[4].plot(t_list, a_list * 3.2808)
#ax[4].plot(testdata['Time (sec)'], testdata['Accel-V (ft/sec^2)'])
...
#ax[0].plot(t_list,m_list)
#ax[0].plot(t_list, testdata['Weight (lb)'][0:np.size(m_list)] * 0.453592)
#ax[1].plot(t_list,m_list-testdata['Weight (lb)'][0:np.size(m_list)] * 0.453592)
#ax[1].plot()
#ax.plot(t_list[3:500], m_list[3:500]-testdata['Weight (lb)'][:-(3372-3258+1)][3:500] * 0.453592)
#ax.grid()
#ax.plot(testdata['Time (sec)'], testdata['Weight (lb)'] * 0.453592)
